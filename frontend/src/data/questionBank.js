const questionBank = {
  ...
  'Python Developer': [
    // ── Easy ──
    { id: 'py-e1', question: 'What is Python and what are its main strengths as a programming language?', difficulty: 'easy', category: 'Python Developer' },
    { id: 'py-e2', question: 'Explain the difference between a list, tuple, set, and dictionary in Python.', difficulty: 'easy', category: 'Python Developer' },
    { id: 'py-e3', question: 'What does virtualenv or venv do in a Python project?', difficulty: 'easy', category: 'Python Developer' },
    { id: 'py-e4', question: 'What is the purpose of pip and requirements.txt?', difficulty: 'easy', category: 'Python Developer' },
    { id: 'py-e5', question: 'What is the difference between a module and a package in Python?', difficulty: 'easy', category: 'Python Developer' },
    { id: 'py-e6', question: 'Explain what an API framework like FastAPI or Flask does.', difficulty: 'easy', category: 'Python Developer' },
    { id: 'py-e7', question: 'What is the difference between mutable and immutable objects in Python?', difficulty: 'easy', category: 'Python Developer' },
    { id: 'py-e8', question: 'What is JSON and how is it commonly used in Python web APIs?', difficulty: 'easy', category: 'Python Developer' },

    // ── Medium ──
    { id: 'py-m1', question: 'Explain how async and await work in Python.', difficulty: 'medium', category: 'Python Developer' },
    { id: 'py-m2', question: 'What is FastAPI and why is it a good choice for building APIs?', difficulty: 'medium', category: 'Python Developer' },
    { id: 'py-m3', question: 'How does dependency injection work in Python applications?', difficulty: 'medium', category: 'Python Developer' },
    { id: 'py-m4', question: 'What are Python decorators and where would you use them?', difficulty: 'medium', category: 'Python Developer' },
    { id: 'py-m5', question: 'How would you structure MongoDB access in a Python backend?', difficulty: 'medium', category: 'Python Developer' },
    { id: 'py-m6', question: 'What is the Global Interpreter Lock (GIL) in Python?', difficulty: 'medium', category: 'Python Developer' },
    { id: 'py-m7', question: 'Explain the difference between threading and multiprocessing in Python.', difficulty: 'medium', category: 'Python Developer' },
    { id: 'py-m8', question: 'How would you handle request validation in FastAPI?', difficulty: 'medium', category: 'Python Developer' },

    // ── Hard ──
    { id: 'py-h1', question: 'How would you design a scalable Python API for high traffic workloads?', difficulty: 'hard', category: 'Python Developer' },
    { id: 'py-h2', question: 'Explain how you would implement background jobs in a Python backend.', difficulty: 'hard', category: 'Python Developer' },
    { id: 'py-h3', question: 'How would you structure error handling and observability in a FastAPI service?', difficulty: 'hard', category: 'Python Developer' },
    { id: 'py-h4', question: 'What strategies would you use to optimize MongoDB performance from Python?', difficulty: 'hard', category: 'Python Developer' },
    { id: 'py-h5', question: 'How would you secure JWT authentication and refresh token handling in Python?', difficulty: 'hard', category: 'Python Developer' },
    { id: 'py-h6', question: 'How would you implement rate limiting and abuse protection in a Python API?', difficulty: 'hard', category: 'Python Developer' },
    { id: 'py-h7', question: 'Explain how you would structure tests for a Python backend with external API calls.', difficulty: 'hard', category: 'Python Developer' },
    { id: 'py-h8', question: 'How would you design a Python service to safely call an external AI API at scale?', difficulty: 'hard', category: 'Python Developer' },
  ],
